...
export const MOCK_POSTS: BlogPost[] = [
  {
    ...
    content: `
      <p>The dawn of the AI Era marks a significant turning point in human history. Unlike previous industrial revolutions, the AI revolution is moving at an exponential pace, transforming how we work, create, and interact with the world.</p>
      <h2>The Shift to Intelligence-as-a-Service</h2>
      <p>We are moving from a world where software is a tool we use, to a world where intelligence is a service we consume. Large Language Models (LLMs) are the engines of this new economy, providing reasoning capabilities that were previously exclusive to human cognition.</p>
      <h2>Autonomous Agents and the Future of Work</h2>
      <p>The next phase of the AI Era is the rise of autonomous agents. These are systems that can set their own goals, reason about complex tasks, and execute actions across different platforms without constant human intervention.</p>
    `
  },
  {
    ...
    content: `
      <p>The concept of an "AI Power House" refers to an organization that has fully integrated artificial intelligence into its operational DNA. This isn't just about using a chatbot for customer service; it's about using AI to optimize every part of the value chain.</p>
      <h2>Supply Chain Optimization</h2>
      <p>AI models can now predict demand with uncanny accuracy, allowing companies to reduce waste and ensure that products are where they need to be, when they need to be there.</p>
      <h2>Personalized Customer Experiences</h2>
      <p>In the AI Power House, every customer interaction is unique. Generative AI allows for the creation of personalized marketing, support, and product recommendations at a scale that was previously impossible.</p>
    `
  },
  {
